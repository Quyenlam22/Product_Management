...
module.exports = (app) => {
    ...
    app.use(systemConfig.prefixAdmin + '/my-account', authMiddleware.requireAuth, myAccountRoutes)
    app.use(systemConfig.prefixAdmin + '/settings', authMiddleware.requireAuth, settingRoutes)
}